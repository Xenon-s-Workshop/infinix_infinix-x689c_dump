...
#BSP:modify lcm driver XLBJHLJL-2 by shiyu.xu 20201105 start
BOOT_LOGO = hdplus1640
#BSP:modify lcm driver XLBJHLJL-2 by shiyu.xu 20201105 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_BUILD_VERNO = CY-X689C-H696-AN
#BSP: add project macro by wanghanfeng 20201030 start
...
CUSTOM_HAL_IMGSENSOR = s5kgm1st_mipi_raw s5kgm1stext2_mipi_raw ov8856ff_mipi_raw gc8034_mipi_raw gc02m1b_mipi_raw ov02b1b_mipi_raw gc6153_serial_yuv pblcs5kgm1st_mipi_raw pblcs5kgm1stext2_mipi_raw pblcov8856ff_mipi_raw pblcgc8034_mipi_raw pblcgc02m1b_mipi_raw pblcov02b1b_mipi_raw pblcgc6153_serial_yuv
CUSTOM_HAL_MAIN2_IMGSENSOR = gc02m1b_mipi_raw ov02b1b_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = s5kgm1st_mipi_raw s5kgm1stext2_mipi_raw
CUSTOM_TRAN_HAL_MAIN3_IMGSENSOR = gc6153_serial_yuv
#ITD:modify by camera driver team end
#BSP: add XLBJHLJL-4 by zhigang.yang for 20201116 start
CUSTOM_HAL_MSENSORLIB = mmc5603_x689
#BSP: add XLBJHLJL-4 by zhigang.yang for 20201116 end
...
#BSP: add XLBJHLJL-4 by zhigang.yang for soft gyro 20201116 start
CUSTOM_KERNEL_GYROSCOPE = yes
VIRTUAL_GYROSCOPE_ALGORITHM = yes
#BSP: add XLBJHLJL-4 by zhigang.yang for soft gyro 20201116 end
#BSP: add XLBJHLJL-4 by zhigang.yang for 20201116 end
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = s5kgm1st_mipi_raw s5kgm1stext2_mipi_raw ov8856ff_mipi_raw gc8034_mipi_raw gc02m1b_mipi_raw ov02b1b_mipi_raw gc6153_serial_yuv
#ITD:modify by camera driver team end
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5kgm1st_mipi_raw s5kgm1stext2_mipi_raw
#ITD:modify by camera driver team end
#BSP: add XLBJHLJL-4 by zhigang.yang for 20201116 start
...
#TSD: modify XLBJHLJL-10 by xiaoshi.guo for 20201118 start
CUSTOM_MODEM=x689_h696_g1
#TSD: modify XLBJHLJL-10 by xiaoshi.guo for 20201118 end
...
#BSP:modify audio bring up XLBJHLJL-5 xinyu.zhao 20201117 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify audio bring up XLBJHLJL-5 xinyu.zhao 20201117 end
...
MTK_BWC_SUPPORT = yes
#TSD:modify KKFBHLJL-10 by xiaoshi.guo 20201118 start
MTK_C2K_LTE_MODE = 0
#TSD:modify KKFBHLJL-10 by xiaoshi.guo 20201118 end
MTK_CAMERA_APP = no
...
#ITD:add cam 3pty function by hongwei.liu 20201130 start
MTK_CAM_HDR_SUPPORT = no
#ITD:add cam 3pty function by hongwei.liu 20201130 end
...
#ITD:modify by hongwei.liu 20201102 start
MTK_CAM_STEREO_CAMERA_SUPPORT = yes
#ITD:modify by hongwei.liu 20201102 end
...
MTK_FM_SUPPORT = yes
#TSD:modify CMSFTASK-8 by dawei.wang 20201119 start
MTK_FM_GPIO_FUNC = yes
#TSD:modify CMSFTASK-8 by dawei.wang 20201119 end
...
#BSP:modify for fast charger XLBJHLJL-1 by qiuwei.wang 20201116 start
MTK_JEITA_STANDARD_SUPPORT = yes
#BSP:modify for fast charger XLBJHLJL-1 by qiuwei.wang 20201116 end
MTK_K64_SUPPORT=yes
...
#TSD: modify VSIM TSDT-76 xiaoshi.guo 20201217 start
MTK_MULTI_SIM_SUPPORT = dsds
#TSD: modify VSIM TSDT-76 xiaoshi.guo 20201217 end
MTK_MUX_CHANNEL = 64
...
#TSD:modify KKFBHLJL-8 by xiaoshi.guo 20201012 start
MTK_PROTOCOL1_RAT_CONFIG = Lf/Lt/W/G
#TSD:modify KKFBHLJL-8 by xiaoshi.guo 20201012 end
...
#TSD: modify XLBJHLJL-10 by xiaoshi.guo 20201118 start
...
#BSP:modify lcm driver XLBJHLJL-2 by shiyu.xu 20201119 start
MTK_HIGH_FRAME_RATE = yes
#BSP:modify lcm driver XLBJHLJL-2 by shiyu.xu 20201119 end
...
#SDD: add for XLBJHLJL-50 by yangjie 20201207 start
MTK_HIGH_FRAME_RATE_DEFAULT_FPS = 90
#SDD: add for XLBJHLJL-50 by yangjie 20201207 end
...
MTK_BUILD_VERNO=X689C-H696AnAo-R-OP-210202V96
TRAN_FINGERPRINT_BUILD_VERNO=210202V96
#SDD: add project sw version by jiangping.guo 20201030 end
#BSP: add project macro by wanghanfeng 20201030 start
CUSTOM_TRAN_PROJECT=tran_x689c
CUSTOM_TRAN_BOM=tran_x689c_an1
